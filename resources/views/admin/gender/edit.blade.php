        ...
        <div class="col-md-9">
            <div class="card mt-5">
                <div class="card-header" style="background-color: #37251b;">
                    <h1 class="card-title" style="color: white;">Update Gender</h1>
                </div>
                <div class="card-body" style="background-color: #ffffff;">
                    <div class="card mt-3">
                        <div class="card-body">
                            <form action="admin.gender.update{{ $gender->gender_id }}" method="post">
                                @method('PUT')
                                @csrf
                                <div class="mb-3">
                                ...
                                <button type="submit" class="btn btn-success col-sm-3">Update Gender</button>
